...
[![Github 所有发行版本下载量](https://img.shields.io/github/downloads/KangLin/TransformCoordinate/total?label=Github%20下载总量)](http://gra.caldis.me/?user=KangLin&repo=KangLin/TransformCoordinate)
...
- Ubuntu
  - 包含玉兔公共库(RabbitCommon)
    - [开发库 libtransformcoordinate-dev_1.1.3_RabbitCommon_amd64.deb](https://github.com/KangLin/TransformCoordinate/releases/download/v1.1.3/libtransformcoordinate-dev_1.1.3_RabbitCommon_amd64.deb)
    - [运行库 libtransformcoordinate_1.1.3_RabbitCommon_amd64.deb](https://github.com/KangLin/TransformCoordinate/releases/download/v1.1.3/libtransformcoordinate_1.1.3_RabbitCommon_amd64.deb)
    - [转换示例程序 transformcoordinate_1.1.3_RabbitCommon_amd64.deb](https://github.com/KangLin/TransformCoordinate/releases/download/v1.1.3/transformcoordinate_1.1.3_RabbitCommon_amd64.deb)
    - 安装
    
          sudo apt install ./libtransformcoordinate_1.1.3_RabbitCommon_amd64.deb \
                           ./transformcoordinate_1.1.3_RabbitCommon_amd64.deb

  - 不包含玉兔公共库(RabbitCommon)。安装前需要先从 [RabbitCommon](https://github.com/KangLin/RabbitCommon/releases/latest) 下载，并安装 RabbitCommon。
    - [开发库 libtransformcoordinate-dev_1.1.3_amd64.deb](https://github.com/KangLin/TransformCoordinate/releases/download/v1.1.3/libtransformcoordinate-dev_1.1.3_amd64.deb)
    - [运行库 libtransformcoordinate_1.1.3_amd64.deb](https://github.com/KangLin/TransformCoordinate/releases/download/v1.1.3/libtransformcoordinate_1.1.3_amd64.deb)
