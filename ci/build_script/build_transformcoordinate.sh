...
case ${RABBIT_BUILD_TARGERT} in
    android)
        ...
        CMAKE_PARA="${CMAKE_PARA} -DCMAKE_TOOLCHAIN_FILE=${RABBIT_BUILD_SOURCE_CODE}/ci/build_script/cmake/platforms/toolchain-android.cmake"
...
#CMAKE_PARA="$CMAKE_PARA -DLibKML_DIR=$RABBIT_BUILD_PREFIX/cmake"
echo "cmake .. \
